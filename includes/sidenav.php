    ...
    <div class="col-lg-3" style="margin-top: 30px;">
      <div class="accordion mb-2" id="accordionExample">
        ...
        <div class="card">
          <div class="card-header" id="headingOne">
            <h2 class="mb-0">                 
              <a data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseOne">
                <span><i class="fa fa-user"></i>Manage Staff</span>
                <i class="fa fa-chevron-down toggle"></i>
              </a>
            </h2>
          </div>
          <div id="collapseTen" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <ul class="list-group">
                <li class="list-group-item"><a href="#"><i class="fa fa-pencil"></i> Staff Information</a></li>
                <li class="list-group-item"><a href="#"><i class="fa fa-key"></i> Add Staff </a></li>
                <li class="list-group-item"><a href="#" class="text-danger"><i class="fa fa-trash"></i> Delete Account</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="card">
          <div class="card-header" id="headingOne">
            <h2 class="mb-0">                 
              <a data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseOne">
                <span><i class="fa fa-user"></i>Manage Students</span>
                <i class="fa fa-chevron-down toggle"></i>
              </a>
            </h2>
          </div>
          <div id="collapseSix" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <ul class="list-group">
                <li class="list-group-item"><a href="display_st.php"><i class="fa fa-pencil"></i> Student Information </a></li>
                <li class="list-group-item"><a href="#"><i class="fa fa-key"></i> Add Student </a></li>
                <li class="list-group-item"><a href="#" class="text-danger"><i class="fa fa-trash"></i> Delete Account</a></li>
              </ul>
            </div>
          </div>
